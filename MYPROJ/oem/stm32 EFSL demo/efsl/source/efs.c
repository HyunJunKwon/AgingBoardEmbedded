...
void efsl_getLocalTime(void)
{
	if_efsl_getLocalTime();
}

euint16 efsl_getYear(void)
{
	return if_efsl_getYear();
}

euint8  efsl_getMonth(void)
{
	return if_efsl_getMonth();
}

euint8  efsl_getDay(void)
{
	return if_efsl_getDay();
}

euint8  efsl_getHour(void)
{
	return if_efsl_getHour();
}

euint8  efsl_getMinute(void)
{
	return if_efsl_getMinute();
}

euint8  efsl_getSecond(void)
{
	return if_efsl_getSecond();
}
