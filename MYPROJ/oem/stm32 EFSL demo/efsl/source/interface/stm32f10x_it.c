...
/* Includes ------------------------------------------------------------------*/
#include "main.h"
   extern volatile short  MenuSel;
  extern volatile  short  MenuLast;
   extern volatile  short  MenuBrowsing;
   extern  short  MenuChange;
/* Private typedef -----------------------------------------------------------*/
/* Private define ------------------------------------------------------------*/
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
...
void EXTI9_5_IRQHandler(void)
{
    ...
    if ((MenuBrowsing >=2)||(MenuBrowsing <0)) MenuBrowsing =0;
...
void EXTI15_10_IRQHandler(void)
{
 ...
 if ((MenuSel >=4)||(MenuSel <0)) MenuSel=0;
